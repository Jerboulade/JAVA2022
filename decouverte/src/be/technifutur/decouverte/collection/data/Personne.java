package be.technifutur.decouverte.collection.data;
...
public class Personne /*implements Comparable<Personne>*/{
    ...
    public boolean equals(Object o) {
        ...
        return name.equals(personne.name) && prenom.equals(personne.prenom) && Objects.equals(naissance, personne.naissance);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, prenom, naissance);
    }
...
/* works but we want to compare Personnes with other parameters
    @Override
