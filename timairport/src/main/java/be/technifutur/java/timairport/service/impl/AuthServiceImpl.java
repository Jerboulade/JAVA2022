...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(UserRepository userRepository, PasswordEncoder encoder, AuthenticationManager authenticationManager, JwtProvider jwtProvider) {
    ...
    public void register(RegistrationForm form) {
        if (!form.getPassword().equals(form.getConfirmPassword()))
            throw new FormValidationException("Passwords not equals!");
    ...
    public JWTHolderDTO login(LoginForm form) {
        ...
        return new JWTHolderDTO(jwtProvider.createToken(auth));
    }
}
